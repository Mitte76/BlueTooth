...
//    }
    ...
    public SmsAdapter(Cursor mCursor) {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.sms_row_item, parent, false);
    ...
    public void onBindViewHolder(ItemViewHolder holder, int position) {
        ...
        if (itemsPendingRemoval.contains(message)) {
            ...
            if (Objects.equals(direction, "1")) {
                ...
                if (bitmap != null) {
                    holder.mmsImageviewLeft.setVisibility(View.VISIBLE);
                    ...
                    holder.mmsImageviewLeft.setImageDrawable(null);
                    holder.mmsImageviewLeft.setOnClickListener(null);
                    holder.mmsImageviewLeft.setVisibility(View.GONE);
                ...
                if (bitmap != null) {
                    ...
                    holder.mmsImageviewRight.setImageBitmap(null);
                    holder.mmsImageviewRight.setOnClickListener(null);
                }
